import{u as P,r as E,s as j,a as $,j as a,b as e,L as T,d as c}from"./index-f31ace3e.js";import{g as N,n as O,S as h,N as y,P as x,a as u}from"./pagination.min-1e83e261.js";import{C as f}from"./Highlight-253c8b2e.js";import{I as B}from"./IconBell-d09f3ef5.js";import{I as v}from"./IconCode-01429d9b.js";function I({swiper:t,extendParams:b,on:l,emit:i}){let m;t.autoplay={running:!1,paused:!1},b({autoplay:{enabled:!1,delay:3e3,waitForTransition:!0,disableOnInteraction:!0,stopOnLastSlide:!1,reverseDirection:!1,pauseOnMouseEnter:!1}});function n(){if(!t.size){t.autoplay.running=!1,t.autoplay.paused=!1;return}const o=t.slides.eq(t.activeIndex);let p=t.params.autoplay.delay;o.attr("data-swiper-autoplay")&&(p=o.attr("data-swiper-autoplay")||t.params.autoplay.delay),clearTimeout(m),m=O(()=>{let d;t.params.autoplay.reverseDirection?t.params.loop?(t.loopFix(),d=t.slidePrev(t.params.speed,!0,!0),i("autoplay")):t.isBeginning?t.params.autoplay.stopOnLastSlide?r():(d=t.slideTo(t.slides.length-1,t.params.speed,!0,!0),i("autoplay")):(d=t.slidePrev(t.params.speed,!0,!0),i("autoplay")):t.params.loop?(t.loopFix(),d=t.slideNext(t.params.speed,!0,!0),i("autoplay")):t.isEnd?t.params.autoplay.stopOnLastSlide?r():(d=t.slideTo(0,t.params.speed,!0,!0),i("autoplay")):(d=t.slideNext(t.params.speed,!0,!0),i("autoplay")),(t.params.cssMode&&t.autoplay.running||d===!1)&&n()},p)}function s(){return typeof m<"u"||t.autoplay.running?!1:(t.autoplay.running=!0,i("autoplayStart"),n(),!0)}function r(){return!t.autoplay.running||typeof m>"u"?!1:(m&&(clearTimeout(m),m=void 0),t.autoplay.running=!1,i("autoplayStop"),!0)}function g(o){t.autoplay.running&&(t.autoplay.paused||(m&&clearTimeout(m),t.autoplay.paused=!0,o===0||!t.params.autoplay.waitForTransition?(t.autoplay.paused=!1,n()):["transitionend","webkitTransitionEnd"].forEach(p=>{t.$wrapperEl[0].addEventListener(p,w)})))}function S(){const o=N();o.visibilityState==="hidden"&&t.autoplay.running&&g(),o.visibilityState==="visible"&&t.autoplay.paused&&(n(),t.autoplay.paused=!1)}function w(o){!t||t.destroyed||!t.$wrapperEl||o.target===t.$wrapperEl[0]&&(["transitionend","webkitTransitionEnd"].forEach(p=>{t.$wrapperEl[0].removeEventListener(p,w)}),t.autoplay.paused=!1,t.autoplay.running?n():r())}function k(){t.params.autoplay.disableOnInteraction?r():(i("autoplayPause"),g()),["transitionend","webkitTransitionEnd"].forEach(o=>{t.$wrapperEl[0].removeEventListener(o,w)})}function C(){t.params.autoplay.disableOnInteraction||(t.autoplay.paused=!1,i("autoplayResume"),n())}function z(){t.params.autoplay.pauseOnMouseEnter&&(t.$el.on("mouseenter",k),t.$el.on("mouseleave",C))}function L(){t.$el.off("mouseenter",k),t.$el.off("mouseleave",C)}l("init",()=>{t.params.autoplay.enabled&&(s(),N().addEventListener("visibilitychange",S),z())}),l("beforeTransitionStart",(o,p,d)=>{t.autoplay.running&&(d||!t.params.autoplay.disableOnInteraction?t.autoplay.pause(p):r())}),l("sliderFirstMove",()=>{t.autoplay.running&&(t.params.autoplay.disableOnInteraction?r():g())}),l("touchEnd",()=>{t.params.cssMode&&t.autoplay.paused&&!t.params.autoplay.disableOnInteraction&&n()}),l("destroy",()=>{L(),t.autoplay.running&&r(),N().removeEventListener("visibilitychange",S)}),Object.assign(t.autoplay,{pause:g,run:n,start:s,stop:r})}const R=()=>{const t=P();E.useEffect(()=>{t(j("Carousel"))});const b=["carousel1.jpeg","carousel2.jpeg","carousel3.jpeg"],l=$(s=>s.themeConfig),[i,m]=E.useState([]),n=s=>{i.includes(s)?m(r=>r.filter(g=>g!==s)):m([...i,s])};return a("div",{children:[a("ul",{className:"flex space-x-2 rtl:space-x-reverse",children:[e("li",{children:e(T,{to:"#",className:"text-primary hover:underline",children:"Components"})}),e("li",{className:"before:content-['/'] ltr:before:mr-2 rtl:before:ml-2",children:e("span",{children:"Carousel"})})]}),a("div",{className:"pt-5 space-y-8",children:[e("div",{className:"panel p-3 flex items-center text-primary overflow-x-auto whitespace-nowrap",children:e("div",{className:"ring-2 ring-primary/30 rounded-full bg-primary text-white p-1.5 ltr:mr-3 rtl:ml-3",children:e(B,{})})}),a("div",{className:"grid lg:grid-cols-2 grid-cols-1 gap-6",children:[a("div",{className:"panel",children:[a("div",{className:"flex items-center justify-between mb-5",children:[e("h5",{className:"font-semibold text-lg dark:text-white-light",children:"Basic"}),e("button",{onClick:()=>n("code1"),className:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",children:a("span",{className:"flex items-center",children:[e(v,{className:"me-2"}),"Code"]})})]}),a(h,{modules:[y,x],navigation:{nextEl:".swiper-button-next-ex1",prevEl:".swiper-button-prev-ex1"},pagination:{clickable:!0},className:"swiper max-w-3xl mx-auto mb-5",id:"slider1",dir:l.rtlClass,children:[e("div",{className:"swiper-wrapper",children:b.map((s,r)=>e(u,{children:e("img",{src:`/assets/images/${s}`,className:"w-full max-h-80 object-cover",alt:"itemImage"})},r))}),e("button",{className:"swiper-button-prev-ex1 grid place-content-center ltr:left-2 rtl:right-2 p-1 transition text-primary hover:text-white border border-primary  hover:border-primary hover:bg-primary rounded-full absolute z-[999] top-1/2 -translate-y-1/2",children:e(c,{className:"w-5 h-5 rtl:-rotate-90 rotate-90"})}),e("button",{className:"swiper-button-next-ex1 grid place-content-center ltr:right-2 rtl:left-2 p-1 transition text-primary hover:text-white border border-primary  hover:border-primary hover:bg-primary rounded-full absolute z-[999] top-1/2 -translate-y-1/2",children:e(c,{className:"w-5 h-5 rtl:rotate-90 -rotate-90"})})]},l.rtlClass==="rtl"?"true":"false"),i.includes("code1")&&e(f,{children:e("pre",{className:"language-typescript",children:`import { Swiper, SwiperSlide } from 'swiper/react';
import 'swiper/css';
