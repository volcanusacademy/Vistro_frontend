import{u as x,r,s as f,j as i,b as e,L as N,c as d,g as p,l as u}from"./index-267a3523.js";import{C as n}from"./Highlight-d1f8eaa6.js";import{I as w}from"./IconBell-c471aaa3.js";import{I as s}from"./IconCode-b3297bcc.js";import{I as c}from"./IconHome-f3034904.js";import{I as m}from"./IconPhone-29d9fe7c.js";import{X as a}from"./tabs-20491b31.js";import"./keyboard-5d9d3865.js";import"./hidden-ef9f944f.js";import"./use-resolve-button-type-d2d07dce.js";const _=()=>{const h=x();r.useEffect(()=>{h(f("Tabs"))});const[l,b]=r.useState([]),o=t=>{l.includes(t)?b(v=>v.filter(g=>g!==t)):b([...l,t])};return i("div",{children:[i("ul",{className:"flex space-x-2 rtl:space-x-reverse",children:[e("li",{children:e(N,{to:"/components/tabs",className:"text-primary hover:underline",children:"Components"})}),e("li",{className:"before:content-['/'] ltr:before:mr-2 rtl:before:ml-2",children:e("span",{children:"Tabs"})})]}),i("div",{className:"space-y-8 pt-5",children:[e("div",{className:"panel flex items-center overflow-x-auto whitespace-nowrap p-3 text-primary",children:e("div",{className:"rounded-full bg-primary p-1.5 text-white ring-2 ring-primary/30 ltr:mr-3 rtl:ml-3",children:e(w,{})})}),i("div",{className:"grid grid-cols-1 gap-6 lg:grid-cols-2",children:[i("div",{className:"panel",id:"simple",children:[i("div",{className:"mb-5 flex items-center justify-between",children:[e("h5",{className:"text-lg font-semibold dark:text-white-light",children:"Simple Tabs"}),e("button",{type:"button",className:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",onClick:()=>o("code1"),children:i("span",{className:"flex items-center",children:[e(s,{className:"me-2"}),"Code"]})})]}),e("div",{className:"mb-5",children:i(a.Group,{children:[i(a.List,{className:"mt-3 flex flex-wrap border-b border-white-light dark:border-[#191e3a]",children:[e(a,{as:r.Fragment,children:({selected:t})=>e("button",{className:`${t?"!border-white-light !border-b-white  text-primary !outline-none dark:!border-[#191e3a] dark:!border-b-black ":""}
