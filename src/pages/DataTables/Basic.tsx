...
const MultipleTables = () => {
    ...
    return (
        ...
        <tr>
            <td>
                <label htmlFor="">Transport Name
                    <select name="Transport Name" style={{border:'1px solid black',borderRadius:'5px', margin:'0px 6px', width:'144px'}}>
            ...
            <td>
                <label htmlFor="">Transport Firm Name
                    <select name="Transport Firm Name" style={{border:'1px solid black',borderRadius:'5px', margin:'0px 6px', width:'144px'}}>
                        <option value="">--ALL--</option>
                    </select>
                </label>
            </td>
            <td>
                ...
                <input type="text" style={{border:'1px solid black',borderRadius:'5px', margin:'0px 6px', width:'144px'}}/>
        ...
        <tr>
            <td>
                <label htmlFor="">City
                <select name="City" style={{border:'1px solid black',borderRadius:'5px', marginLeft:'84px', width:'144px'}}>
                        <option value="">--ALL--</option>
                    </select>
                </label>
            </td>
            <td>
                <label htmlFor="">State
                    <select name="State" style={{border:'1px solid black',borderRadius:'5px', marginLeft:'108px', width:'144px'}}>
                        <option value="">--ALL--</option>
                    </select>
                </label>
            </td>
            <td>
                <label htmlFor="">Status
                    <select name="Status" style={{border:'1px solid black',borderRadius:'5px', marginLeft:'32px', width:'144px'}}>
