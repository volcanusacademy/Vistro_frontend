...
const Dealers = () => {
    ...
    return (
        ...
        <tr>
            <td>
                <label htmlFor="">Dealer Name
                    <select name="Dealer Name"style={{border:'1px solid #e5e7eb',borderRadius:'5px', marginLeft:'26px', width:'144px'}}>
                        <option value="">--ALL--</option>
                    </select>
                </label>
            </td>
            <td>
                <label htmlFor="">Dealer Firm Name
                    <select name="Dealer Firm Name"style={{border:'1px solid #e5e7eb',borderRadius:'5px', marginLeft:'25px', width:'144px'}}>
                        <option value="">--ALL--</option>
                    </select>
                </label>
            </td>
        ...
        <td>
                <label htmlFor="">City 
                    <select name="City"style={{border:'1px solid #e5e7eb',borderRadius:'5px', marginLeft:'85px', width:'144px'}}>
                        <option value="">--ALL--</option>
                    </select>
                </label>
            </td>
