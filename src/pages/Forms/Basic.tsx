        ...
        <tr>
            <td>
                <label htmlFor="">Customer Name
                    <select name="CustomerName" style={{border:'1px solid black',borderRadius:'5px', margin:'0px 6px', padding:'0px 40px'}}>
            ...
            <label htmlFor="">Firm name
                    <select name="FirmName" style={{border:'1px solid black',borderRadius:'5px', margin:'0px 6px', padding:'0px 54px'}}>
                        <option value="">--ALL--</option>
                    </select>
                </label>
            </td>
            <td>
                ...
                <select name="SalePrice" style={{border:'1px solid black',borderRadius:'5px', margin:'0px 6px', padding:'0px 54px'}}>
                        <option value="">--ALL--</option>
                    </select>
                </label>
            </td>
            <td>
                <label htmlFor="" style={{marginLeft:'8px'}}>Mobile no
                <input type="text" style={{border:'1px solid black',borderRadius:'5px', margin:'0px 6px', padding:'0px 7px'}}/>
                </label>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <label htmlFor="">City name
                    <select name="City" style={{border:'1px solid black',borderRadius:'5px', padding:'0px 40px', marginLeft:'16%'}}>
                        <option value="">--ALL--</option>
                    </select>
                </label>
            </td>
            <td>
                <label htmlFor="">State
                    <select name="State" style={{border:'1px solid black',borderRadius:'5px', marginLeft:'14%', padding:'0px 54px'}}>
                        <option value="">--ALL--</option>
                    </select>
                </label>
            </td>
            <td>
                <label htmlFor="">GSTNo
                    {/* <select name="GSTNo" style={{border:'1px solid black',borderRadius:'5px', margin:'0px 6px', padding:'0px 7px'}}>
                        <option value="">--ALL--</option>

                    </select> */}
                    <input type="text" style={{border:'1px solid black',borderRadius:'5px', marginLeft:'7%', padding:'0px 7px'}}/>
                </label>
            </td>
