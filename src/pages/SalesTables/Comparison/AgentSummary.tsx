                ...
                <div>
                    <table>
                        <tr>
                            <td>
                                <label htmlFor="">Agent
                                    <select name="Agent" style={{ border: '1px solid #e5e7eb', borderRadius: '5px', margin: '0px 6px', width: '100px' }}
                            ...
                            <td>
                                <label htmlFor="">Customer
                                    <select name="Customer" style={{ border: '1px solid #e5e7eb', borderRadius: '5px', margin: '0px 6px', width: '100px' }}
                                        value={selectedTransport}
                                        onChange={handleDropdownChange}
                                    >
                                        <option value="">--ALL--</option>
                            ...
                            <td>
                                <label htmlFor="">CType
                                    <select name="CType" style={{ border: '1px solid #e5e7eb', borderRadius: '5px', marginLeft: '32px', width: '100px' }}
                            ...
                            <td>
                                <label htmlFor="">From Date 
                                    <input type="date" style={{ border: '1px solid #e5e7eb', borderRadius: '5px', margin: '0px 6px', width: '100px' }} />
                        ...
                        <td>
                                <label htmlFor="">City
                                    <select name="City" style={{ border: '1px solid #e5e7eb', borderRadius: '5px', marginLeft: '108px', width: '100px' }}
                                        value={selectedState}
                                        onChange={handleDropdownChange}
                                    >
                                        <option value="">--ALL--</option>
                            ...
                            <td>
                                <label htmlFor="">State
                                    <select name="State" style={{ border: '1px solid #e5e7eb', borderRadius: '5px', marginLeft: '108px', width: '100px' }}
                                        value={selectedState}
                                        onChange={handleDropdownChange}
                                    >
                                        <option value="">--ALL--</option>
                            ...
                            <td>
                                <label htmlFor="">Series
                                    <input type="text" style={{ border: '1px solid #e5e7eb', borderRadius: '5px', margin: '0px 6px', width: '100px' }} />

                                </label>
                            </td>
                            <td>
                                <label htmlFor="">No. From
                                    <input type="text" style={{ border: '1px solid #e5e7eb', borderRadius: '5px', margin: '0px 6px', width: '100px' }} />
                                </label>
                            </td>
                            <td>
