                        ...
                        <tr>
                            <td>
                                <label htmlFor="">Customer Name
                                    <select name="Customer Name" style={{ border: '1px solid #e5e7eb', borderRadius: '5px', margin: '0px 6px', width: '100px' }}
                            ...
                            <td>
                                <label htmlFor="">Consignee Name
                                    <select name="Consignee Name" style={{ border: '1px solid #e5e7eb', borderRadius: '5px', margin: '0px 6px', width: '100px' }}
                                        value={selectedTransport}
                                        onChange={handleDropdownChange}
                                    >
                                        <option value="">--ALL--</option>
...
export default ConsigneeSummary;
