                        ...
                        <tr>
                            <td>
                                <label htmlFor="">Helper Name
                                    <select name="Helper Name" style={{ border: '1px solid #e5e7eb', borderRadius: '5px', margin: '0px 6px', width: '144px' }}
                            ...
                            {/* <td>
                                <label htmlFor="">Product
                                    <select name="Product Name" style={{ border: '1px solid #e5e7eb', borderRadius: '5px', margin: '0px 6px', width: '144px' }}
                                        value={selectedFirm}
                                        onChange={handleDropdownChange}
...
export default HelperCompareQty;
