            ...
            <div className="panel mt-6">
                ...
                <table>
                    ...
                    <tr style={{ display: 'flex', flexDirection: 'row' }}>
                        ...
                        <label htmlFor="" style={{ marginLeft: '0px' }}>Unit
                        ...
                        <label htmlFor="" style={{ marginLeft: '2%' }}>Category
                            <select name="Brand" style={{ border: '1px solid black', borderRadius: '5px', marginLeft: '3px',width:'144px' }}>
                                <option value="">--ALL--</option>
                            </select>
                        </label>
                        <label htmlFor="" style={{ marginLeft: '2%' }}>MRP Range From
                            <input type="text" style={{ border: '1px solid black', borderRadius: '5px', marginLeft: '5px', width:'144px' }} />
                        </label>

                        <label htmlFor="" style={{ marginLeft: '2%' }}>To
                            <input type="text" style={{ border: '1px solid black', borderRadius: '5px', marginLeft: '17px', width:'144px' }} />
                        </label>

                        <label htmlFor="" style={{ marginLeft: '2%' }}>Fit
                            <select name="Style" style={{ border: '1px solid black', borderRadius: '5px', marginLeft: '22px', width:'144px' }}>
                                <option value="">--ALL--</option>
                            </select>
                        </label>
                    </tr>
